...
CREATE USER 'gpio'@'localhost' IDENTIFIED BY  'gpio';

GRANT ALL PRIVILEGES ON * . * TO  'gpio'@'localhost' IDENTIFIED BY  'gpio' WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

GRANT ALL PRIVILEGES ON  `gpio` . * TO  'gpio'@'localhost';
