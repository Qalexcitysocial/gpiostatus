...
$MySQLHost = "localhost";
$MySQLDB = "gpio";
If (($MySQLUsername == "admin") || ($MySQLPassword == "admin")){
...
If (isset($_GET['action'])){
    If ($_GET['action'] == "logout"){
        ...
        if ($action == "turnOn"){
            ...
            <head>
            <title>Auto Settings for Pin ' . $pinDays . '</title>
            </head>
            <body>';
            print '<form name="autoEdits" action="control.php" method="get"> ';
            print '<div style="overflow-x:auto;"><table name="Times" border="1" cellpadding="3">
           ...
           print ' </table>';
                    ...
                    print '<table name="days" border="2" cellpadding="7">';
            ...
            <head>
            <title>Update Pin ' . $pin . '</title></head><body>
            <div style="overflow-x:auto;">
            <table>
    ...
    print '
        ...
        print '<div style="overflow-x:auto;"><table name="GPIO" border="1" cellpadding="6">';
